...
var wizardInit = function wizardInit() {
  ...
  wizards.forEach(function (wizard) {
    ...
    var inputName = wizard.querySelector('[data-wizard-validate-name]');
    var inputAge = wizard.querySelector('[data-wizard-validate-age]');
    var inputTicketType = wizard.querySelector('[data-wizard-validate-ticket_type]');
    ...
    nextButton.addEventListener('click', function () {
      if ((!inputEmail.value || !inputAge.value || !inputName.value || !inputTicketType.value) && form.className.includes('needs-validation')) {
        form.classList.add('was-validated');
      } else {
        count += 1;
