            ...
            <div class="card-body position-relative">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <a class="btn btn-link btn-sm ps-0 mt-2" href="{{ url('/') }}" target="_blank"> قائمة الكوبونات <span class="fas fa-chevron-left ms-1 fs--2"></span>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto col-lg align-self-center">
                    <h5 class="mb-0" data-anchor="data-anchor">قائمة الكوبونات</h5>
                </div>
                <div class="col-6 col-sm-auto ms-auto text-end ps-0">
                    ...
                    <div id="table-purchases-replace-element">
                        <a class="btn btn-falcon-success btn-sm" href="#!" data-bs-toggle="modal" data-bs-target="#newTemp">
                            ...
                            <span class="d-none d-sm-inline-block ms-1">اضافة كوبون جديد</span>
                        </a>
                    ...
                    @foreach($coupons as $item)
                        ...
                        <tr class="btn-reveal-trigger">
                            ...
                            <td class="text-end">
                                ...
                                <a href="#" id="btn_{{ $item->id }}" onclick="copyToClipboard('copy_{{ $item->id }}','btn_{{ $item->id }}','copyResult{{ $item->id }}');">نسخ الكوبون</a> <span id="copyResult{{ $item->id }}" style="color: green"></span>
                            </td>
                        </tr>
            ...
            <div class="modal-content border-0">
                <div class="modal-header px-5 position-relative modal-shape-header bg-shape">
                    ...
                    <div class="position-relative z-index-1 light">
                        <h4 class="mb-0 text-white" id="authentication-modal-label">اضافة كوبون جديد </h4>
{{--                        <p class="fs--1 mb-0 text-white">عند اضافة قالب جديد يجب الانتظار لمدة 5 دقيقة للموافقة عليه</p>--}}
                ...
                <div class="modal-body py-4 px-5">
                    <form method="post" action="{{ route('addCoupon') }}">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="subtitle">الكود</label>
                            <input class="form-control" type="text" name="code"/>
                        </div>

                        <div class="mb-3">
                            <label class="form-label" for="subtitle">نسبة الخصم</label>
    ...
    <script>
        let copyToClipboard = (txt,btn,spn) => {
            ...
            if(successful){
                answer.innerHTML = 'تم نسخ الكوبون';
            } else {
