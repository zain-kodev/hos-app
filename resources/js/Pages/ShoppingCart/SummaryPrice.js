...
const SummaryPrice = ({ meta }) => {
    ...
    return (
        <>
            ...
            <div className="mb-5">
                <Heading3 className="mb-10">اجمالي مبلغ السلة</Heading3>
                <table className="w-full">
                    <tbody>
                        <tr className="border-b border-gray-200">
                            <td className="py-4 px-2 md:w-1/5">
                                <Heading5> المجموع الفرعي </Heading5>
                            </td>
                        ...
                        <tr className="border-b border-gray-200">
                            <td className="py-4 px-2 md:w-1/5">
                                <Heading5> الضريبة (15%) </Heading5>
                            </td>
                            <td className="py-4 px-2 font-text font-bold">
                                {formatCurrency(meta.tax_amount)}
                            </td>
                        </tr>

                        <tr className="border-b border-gray-200">
                            <td className="py-4 px-2 md:w-1/5">
                                <Heading5> المجموع </Heading5>
                            </td>
                            <td className="py-4 px-2 font-text font-bold">
