...
use App\Http\Resources\VariationTitleResource;
...
class PageController extends Controller
{
    public function home()
    {
        ...
        $products = Product::where('active', 1)->inRandomOrder()->take(3)->whereIn('id',[15,17,25])->get();
...
//        return response()->json(['products' => $products]);
    ...
    {
        $product = Product::where('active', 1)->where('slug', $slug)->with('images', 'category', 'variations_title.variations')->firstOrFail();
        $variation = ProductVariation::all();
        ...
        //dd(new VariationResource($product->variations_title));
