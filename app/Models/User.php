...
class User extends Authenticatable
{
    ...
    {
        return $this->belongsToMany(Product::class, 'shopping_cart')->withPivot('quantity', 'total_price_quantity','variations')->withTimestamps();
    }
    ...
    public function getShoppingCartTotalAttribute()
    {
        ...
        $discount_availables = DiscountCode::get();
        $discount = null;
